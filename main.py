...
controller.combos.attachCombo("ABABABAB", function () {
    game.showLongText("Congrats you found the Easter egg", DialogLayout.Bottom)
    game.gameOver(true)
})
...
// Allows the board to be set up correctly.
